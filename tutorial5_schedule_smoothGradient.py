...
### First we observe the default ordering.
    ...
    start_default = time()
    output_default = gradient.realize(800, 600)
    finish_default = time()
    print 'Default gradient time:', finish_default - start_default
...
# Putting it all together.
    ...
    start_fast = time()
    output_fast = gradient_fast.realize(800, 600)
    finish_fast = time()
    print 'Fast gradient time:', finish_fast - start_fast
